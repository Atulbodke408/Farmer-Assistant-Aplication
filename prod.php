            ...
            <div class="row mt_10 ">
              <div class="col-md-5">
                    ...
                    $i = 0;
                     ...
                     if ($result2 = $con->query($select_more)) {
                       ...
                       while ($data2= $result2->fetch_assoc()) {
                             ...
                             {
                             // echo $i;
                              echo "<input type='hidden' name='id' value='".$data2["id"]."'>";
                                  ...
                                  echo '
                                         <span class="price mb-20"><span class="amount price_disp">
                                            <span class="currencySymbol">Price : </span>
                                             <span id = "disc_price_strike"> <strike> '.$data2["prod_price"].' ₹</strike></span>
                ...
                <div class="prod_desc" style="margin-top: 4%">
                  <h4>Description</h4>
                  <p>
                    <?php echo strip_tags($product_desc);?>
                  </p>
                  <hr>
                  <h4>Benifits</h4>
                   <p><?php echo strip_tags($product_desc);?></p>
                </div>
                </form>
              </div>
                ...
                <div class="related_pro">
                  <div class="product-layout related-pro  owl-carousel mb-50 ">
                   ';
                        ...
                        $query2 = "select * from product where category = '$category' and id <> '$id' limit 10";
                              ...
                              while ($data2 = $result2->fetch_assoc()) {
                                ...
                                $realpath = dirname($data2["img"]);
                                            $path = str_replace($realpath, "", trim($data2["img"]));
                                             $path=  "images/".$path;
                                             $prod_id = $data2["id"];
                                  $select_prod_price = "select * from product where id = '$prod_id' ";
                        ...
                        if ($result3 = $con->query($select_prod_price)) {
                         ...
                         <div class="product-thumb transition">
                            <div class="image">
                              <div class="first_image"> <a href="prod.php?prod='.$data2["prod_name"].'"> <img style="width:250px;height:300px" src="'.$path.'" alt="'.$data2["prod_name"].'" title="'.$data2["prod_name"].'" class="img-responsive"> </a> </div>
                              
                            </div>
                            <div class="product-details">
                              <div class="caption">
                                <h4 class="" style="font-size:21px;font-weight:bold;line-height: 1;"><a style="font-size:15px;" href="prod.php?prod='.$data2["prod_name"].'">'.mb_strimwidth($data2["prod_name"], 0, 20,'...').'</a></h4>
                                <p class="price" style="font-weight:bold">'.$prod_price.' Rs.</p>
                                
                                <div class="product_option">
                                  <div class="row" style="width:98%;margin:auto;margin-top:8%">
                                    <div class="col-md-6 col-sm-6" >
                                      <a style="width:100%;background-color:#03a9f4;color:white" class="btn btn-info" href="prod.php?prod='.$data2["prod_name"].'">View</a>
                                    </div>
                                    <div class="col-md-6 col-sm-6" style="text-align:end">
                                      <a style="width:100%;background-color:#4caf50;color:white" class="btn btn-success" href="prod.php?prod='.$data2["prod_name"].'">Buy Now</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
