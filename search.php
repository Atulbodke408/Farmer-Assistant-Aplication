        ...
        <div class="row">
          ...
          <div class="section-product grid section">
            <?php
                    	...
                    	//$query = "SELECT * FROM products where id in ($prodids) and name like '%$prod_name%' ";
                      ...
                      $realpath = dirname($data["img"]);
                       ...
                       echo '<div class=" product-items col-6 col-sm-4 col-md-4 col-lg-3">
                              <div class="product-thumb transition">
                               <div class="image">
                                  <div class="first_image"> <a href="prod.php?prod='.$data["prod_name"].'"> <img src="'.$path.'" style="min-height:170px;min-width:220px;max-height:170px;max-width:220px" alt="'.$data["prod_name"].'" title="'.$data["prod_name"].'" class="img-responsive featured_img"> </a> </div>
                                 
                                </div>
                                <div class="product-details">
                                  <div class="caption">
                                    <h4 class="text-center" style="float: none;"><a href="prod.php?prod='.$data["prod_name"].'">'.$data["prod_name"].'</a></h4><br>
                                    <p class="price" style="float: none;text-align: center;">'.$data["prod_price"].'  Rs.<span class="price-tax">'.$data["prod_price"].'Rs.</span></p>
                                    <div class="product_option">
                                      <br>
                                      <div class="input-group button-group">
                                        <label class="control-label">Qty</label>
                                        <input type="number" name="quantity" min="1" value="1" step="1" class="qty form-control">
                                       <a href="prod.php?prod='.$data["prod_name"].'"> <button type="button" class="addtocart pull-right">Add</button></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
